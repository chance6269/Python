# -*- coding: utf-8 -*-
"""
Created on Tue Mar 26 11:39:45 2024
...
CLIENT_ID = '3b885ff17c804588b9df7d4cd7f9f512'
CLIENT_SECRET = 'e0cfe8a470dc4f9cb0bc2f3a7745e217'
...
r_token
"""
{'access_token': 'BQCe4VL6DXDiXM7fetQyDFy6NK31nVGMBTssQKmtC9uCLW97lgWnVKooimNL3zdNDlVwYQafXz6SDvBn2UzFJ30cIwIWdBjbYWeXsFjy4XJ9oAQnEFI',
 'token_type': 'Bearer',
 'expires_in': 3600} # 3600초 단위로 만료
"""
...
# %%
artist_id = "4CYjITN8Au3K5CWFeex7fU" # 태버의 아티스트 ID
artist_data = get_spotify_artist_info(artist_id)
...
# In[ ]:
    ...
    # artists_info : df_artist_top_track3['artists'][i]
    # 요소가 딕셔너리 1개인 리스트
...
def get_artists(artists_info):
    artists_name = []
    for artist_info in artists_info: ## []를 벗기기 위한 반복문
...
df_tabber_top_track = get_artist_top_track(artist_id, country_code)
df_tabber_top_track.head()
...
artist_albums_data = get_spotify_artist_albums_tracks(artist_id)
...
df_Tabber_albums = get_artist_albums(artist_id)
df_Tabber_albums.head()
