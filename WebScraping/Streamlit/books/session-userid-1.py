# -*- coding: utf-8 -*-
"""
Created on Wed Mar 27 15:31:22 2024
...
if user_id == None:
    user_id = st.sidebar.text_input('아이디 입력', value=None, max_chars=15)
    user_password = st.sidebar.text_input('패스워드 입력', value="abcd",)
